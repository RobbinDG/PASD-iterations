...
\textbf{Preconditions}:&\begin{tabular}[t]{@{}l}User is identified and authenticated.\\The user has a total number of book reservations smaller than \textbf{10}   \footnotemark.\end{tabular}\\
...
\end{tabular}\\\\
\footnotetext{arbitrary constant, can be modified at client's discretion}
