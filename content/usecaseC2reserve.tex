...
\textbf{Stakeholders and Interests}:&\begin{tabular}[t]{@{}l}Viewer: wants to make a unique reservation (that can not be further \\overridden by another reservation) for a book in the catalogue.\end{tabular}\\
...
\begin{enumerate}[noitemsep]
	...
	\item If the selected book is already reserved, show "Failed" and the reason, else mark the book as being reserved by the user and notify the user that he has successfully reserved the book with <itemID>.
\end{enumerate}
