...
addSearchRequest(request paraometers)&\begin{tabular}[t]{@{}l}Requests the system to add a search request, to be created\\from the provided parameters.\end{tabular}\\\hline
