...
\textbf{Frequency of occurence}:& \begin{tabular}[t]{@{}l}Varies greatly, from 3 times a day, to once a week.\\Estimated to be 12 times per month.\footnote{The numbers came from a contact session with John. Session details are in the references.}\end{tabular}
\end{tabular}\\\\
