...
The system allows permitted users to add goods to the system. To do this, they need to provide a range of information about the item(s) and the owner, such as
\begin{itemize}[noitemsep]
...
\end{itemize}
After entering the necessary information, the system will process it and return a confirmation or failure. 
Important is that this action is limited to a certain user group, specifically the purchasing agent(s) and higher authorities.\\[\baselineskip]
...
\begin{enumerate}[noitemsep]
	...
	\item The user provides all necessary information and chooses a category for the item, and an auction date.
