...
\begin{enumerate}[noitemsep]
	...
	\end{itemize}
	\item The system adds the item with all provided parameters to the list.
	\item The system returns to the user with a confirmation message containing the item ID, or a failure.
\end{enumerate}
\textsl{Extensions}
\begin{itemize}[noitemsep]
